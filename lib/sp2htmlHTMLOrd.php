...
* sp2htmlHTMLOrd.php
*
* funzione di creazione pagina ordine.
*
*********************************************************/

if($k==0) {
   eval(" fwrite(\$fout, \"".$sp2htmlConf->tplData['ord-rendering']['header']."\"); ");
} // IF $K = 0
...
eval(" fwrite(\$fout, \"".$sp2htmlConf->tplData['ord-rendering']['bodyheader']."\"); "); 


foreach($sp2htmlData->docBody as $corpo) {
eval(" fwrite(\$fout, \"".$sp2htmlConf->tplData['ord-rendering']['body']."\"); "); 
}


eval(" fwrite(\$fout, \"".$sp2htmlConf->tplData['ord-rendering']['bodydata']."\"); "); 


eval(" fwrite(\$fout, \"".$sp2htmlConf->tplData['ord-rendering']['bodyfooter']."\"); "); 

if(($k+1) == $totPages) {
   eval(" fwrite(\$fout, \"".$sp2htmlConf->tplData['ord-rendering']['footer']."\"); ");
}
